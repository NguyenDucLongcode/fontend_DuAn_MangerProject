...
export default function ModalProjectFilterDate() {
  const dispatch = useAppDispatch();
  const isOpen = useSelector(
    (state: RootState) => state.modal.modalUser.isFilterDateSubscription
  );
  ...
  const CloseModal = () => {
    dispatch(setShowModalSubscription.filterDate(false));
  };
